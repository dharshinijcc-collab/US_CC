...
import { collectHnPosts } from './hackernews';
import { collectPhPosts } from './producthunt';
...
export { collectHnPosts } from './hackernews';
export { collectPhPosts } from './producthunt';
