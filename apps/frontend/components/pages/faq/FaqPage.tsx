  ...
  return (
    <>
      ...
      <div className="faq-page" style={{ position: 'relative', overflow: 'hidden', backgroundColor: '#F8FAFC' }}>
        ...
        {/* Hero Section */}
        <FaqHero faqContent={faqContent} handleScroll={handleScroll} magBtn={magBtn} />

        {/* FAQ Content Section */}
        <FaqList faqContent={faqContent} activeTab={activeTab} setActiveTab={setActiveTab} faqsData={faqsData} openFaq={openFaq} toggleFaq={toggleFaq} magBtn2={magBtn2} />
