...
export default function ResourcesPage() {
  ...
  const toolsCards = [
    ...
    },
    {
      ...
      title: 'Social Validation Engine', status: 'LIVE', statusColor: '#10B981', statusBg: 'rgba(16, 185, 129, 0.1)',
      ...
      href: '/resources/social-validation'
    },
    {
      icon: (
        <svg width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <section style={{ backgroundColor: '#FFFFFF', position: 'relative' }}>
          ...
          <div className="cards-grid">
            {(() => {
              ...
              // Sort cards: LIVE/ACTIVE first, COMING SOON last
              ...
              return sortedCards.map((tool, idx) => {
                ...
                const href = tool.href || originalCard.href;
