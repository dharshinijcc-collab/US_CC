                ...
                {section.social && (
                  <div className="social-icons" style={{ marginBottom: '16px' }}>
                    {section.social.map((social, sIdx) => (
                      <Link key={sIdx} href={social.name === 'in' ? 'https://www.linkedin.com/company/crestcode-technologies/' : social.href} className="social-icon" style={{ backgroundColor: '#005AE2', width: '32px', height: '32px', borderRadius: '6px' }}>
                        {social.name === 'in' ? (
