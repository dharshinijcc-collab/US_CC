...
export function runRuleEngine(signals: ExtractedSignals, ruleModifiers?: Record<string, number>): Record<string, DimensionRuleResult> {
  const getPoints = (label: string, defaultPoints: number): number => {
