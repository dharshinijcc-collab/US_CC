...
const link = document.createElement('a');
  ...
  return (
    <div className="validator-container cc-page-enter" style={{ paddingBottom: '100px', position: 'relative' }}>
      ...
      {/* ── Free Tool: Build Time Estimator (very last section) ── */}
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '0 24px 48px' }}>
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: '260px' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(255,255,255,0.15)', borderRadius: '20px', padding: '5px 14px', marginBottom: '14px' }}>
