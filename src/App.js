    ...
    <>
      ...
      <style dangerouslySetInnerHTML={{
        ...
        * { box-sizing: border-box; }
        ...
        .aura-1 { background: radial-gradient(circle, #4F46E5, transparent 70%); top: -200px; left: -150px; }
        .aura-2 { background: radial-gradient(circle, #005AE2, transparent 70%); bottom: -150px; right: -150px; animation-delay: -7s; }
        ...
        @media (max-width: 768px) {
          ...
          .features-grid-4 { grid-template-columns: 1fr !important; gap: 20px !important; }
          
          /* Mobile card adjustments */
          .sys-card-small { padding: 24px 20px !important; }
          .sys-card { padding: 32px 24px !important; }
        }
