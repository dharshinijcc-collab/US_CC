...
def _send_email(to_email: str, subject: str, html_body: str, reply_to: str = None) -> None:
...
def send_contact_confirmation(to_email: str, first_name: str, service: str, message: str, company: str = "", stage: str = "") -> None:
...
def send_idea_confirmation(to_email: str, name: str, idea_preview: str) -> None:
...
def send_talent_confirmation(to_email: str, first_name: str, interest: str) -> None:
...
def send_investor_confirmation(to_email: str, full_name: str, expertise: str) -> None:
...
def send_idea_confirmation_delayed(to_email: str, name: str, idea_preview: str, delay_minutes: int = 5) -> None:
